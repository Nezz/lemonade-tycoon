...
import { WEATHER_TYPES, WEATHER_WEIGHTS, FORECAST_ACCURACY } from './constants';
 ...
 */
export function generateWeather(forecast: WeatherType | null, accuracy: number = FORECAST_ACCURACY): WeatherType {
